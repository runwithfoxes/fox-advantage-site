...
- If someone says they can't close the chat, or that the chat window is blocking the screen, tell them there's a little X in the top right corner of the chat to close it. Don't tell them to scroll down or refresh the page, the X is what they want.
