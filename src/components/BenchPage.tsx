...
export default function BenchPage() {
  ...
  return (
    <div className="hp-root">
      ...
      <nav className="bench-nav" id="topNav">
        <a href="#top" className="bench-nav-logo" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
          /<span>Run</span>withfoxes
        </a>
      </nav>

      <div className="cl-modules-wrap bench-modules-wrap" ref={modulesRef}>
      ...
      <div className="hp-bottom-bar" ref={bottomBarRef}>
        <a href="#top" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>#top</a>
