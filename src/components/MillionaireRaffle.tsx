...
const lineStyles: { color: string; width: number; opacity: number }[] = [
  ...
  { color: "#3A7CA5", width: 3, opacity: 1 },
];
...
function SalesChart() {
  ...
  return (
    ...
    >
      ...
      {/* 2020 peak marker */}
      <circle cx={x(22)} cy={y(2500)} r={3.5} fill="#3A7CA5" className="proj-chart-dot" />
      ...
      <g transform={`translate(${pad.left}, ${H - 8})`}>
        ...
        <line x1={150} y1={-4} x2={168} y2={-4} stroke="#3A7CA5" strokeWidth={2.5} />
