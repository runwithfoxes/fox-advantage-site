  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        links: [{ tag: "floor 1", label: "Interactive experience (coming soon)" }],
      },
      {
        ...
        links: [{ tag: "floor 2", label: "Interactive experience (coming soon)" }],
      },
      {
        ...
        links: [{ tag: "floor 3", label: "Interactive experience (coming soon)" }],
      },
      {
        ...
        links: [{ tag: "floor 4", label: "Interactive experience (coming soon)" }],
      },
      {
        name: "Marketing technology",
        desc: "CRM, automation, tag management. The stack keeps growing. The skill is deciding what matters and simplifying.",
        links: [{ tag: "floor 5", label: "Interactive experience (coming soon)" }],
      },
      {
        ...
        links: [{ tag: "floor 6", label: "Interactive experience (coming soon)" }],
      },
      {
        ...
        links: [{ tag: "floor 7", label: "Interactive experience (coming soon)" }],
      },
      {
        ...
        links: [{ tag: "floor 8", label: "Interactive experience (coming soon)" }],
      },
      {
        ...
        links: [{ tag: "floor 9", label: "Interactive experience (coming soon)" }],
      },
    ],
  },
];
