...
function NodeItem({ node }: { node: NodeItem }) {
  ...
  return (
    <div style={{ borderBottom: "1px solid #E0E0DC" }}>
      ...
      >
        <span style={{ color: "#3A7CA5", fontSize: "0.8125rem", fontWeight: 400, flexShrink: 0 }}>/</span>
        <span style={{ flex: 1 }}>{node.name}</span>
        <span
          style={{
            color: open ? "#3A7CA5" : "#8A8A85",
            fontSize: 12,
            flexShrink: 0,
...
function BranchPanel({ branch, isOpen, onToggle }: { branch: Branch; isOpen: boolean; onToggle: () => void }) {
  return (
    <div
      style={{
        border: `1px solid ${isOpen ? "#3A7CA5" : "#E0E0DC"}`,
    ...
    <div style={{ display: "flex", justifyContent: "center", marginBottom: 64 }}>
      <div style={{ position: "relative", width: 360, height: 210 }}>
        <svg viewBox="0 0 360 210" style={{ width: "100%", height: "100%" }}>
          ...
          {/* Orbiting dot */}
          <circle r="3" fill="#3A7CA5" opacity="0.6">
            <animateMotion
              dur="8s"
          ...
          {/* Second dot, offset */}
          <circle r="2.5" fill="#3A7CA5" opacity="0.35">
            <animateMotion
              dur="8s"
              repeatCount="indefinite"
              path="M 180 30 L 310 180 L 50 180 Z"
        ...
        <button
          ...
          style={{
            ...
            color: activeBranch === "behaviours" ? "#3A7CA5" : "#8A8A85",
            padding: "8px 16px",
        ...
        <button
          ...
          style={{
            ...
            letterSpacing: 2,
            textTransform: "uppercase" as const,
            color: activeBranch === "knowledge" ? "#3A7CA5" : "#8A8A85",
            padding: "8px 16px",
            transition: "color 0.3s ease-out",
          }}
        >
        ...
        <button
          ...
          style={{
            ...
            letterSpacing: 2,
            textTransform: "uppercase" as const,
            color: activeBranch === "tools" ? "#3A7CA5" : "#8A8A85",
            padding: "8px 16px",
            transition: "color 0.3s ease-out",
          }}
        >
