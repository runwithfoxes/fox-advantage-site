    ...
    >
      ...
      <section style={{ padding: "20px 0 60px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 48px" }}>
          <div style={{ borderLeft: "3px solid #3A7CA5", paddingLeft: 24 }}>
            <p
              style={{
                fontFamily: "'Space Grotesk', sans-serif",
            ...
            <p style={{ fontSize: "0.75rem", color: "#8A8A85", marginTop: 8 }}>
              <a href="/chapter/ch37-tiktok-writer" style={{ color: "#3A7CA5", textDecoration: "none" }}>
              ...
              >
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                  {step.what.map((item, i) => (
                    ...
                    >
                      <span style={{ color: "#3A7CA5", flexShrink: 0 }}>/</span>
                      {item}
                    </li>
                  ))}
                </ul>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 48px" }}>
          ...
          <div style={{ display: "grid", gap: 12 }}>
            {[
              ...
              >
                <div style={{ fontSize: "0.875rem", fontWeight: 400, color: "#3A7CA5", marginBottom: 4 }}>
                  {ch.label}
                </div>
