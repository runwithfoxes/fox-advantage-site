...
/*
  PROSPECT HERO - the homepage AgentsHero (src/components/AgentsHero.tsx),
  parameterised for a prospect page: kicker (prepared for ...), headline, sub
  and the terminal instruction are props; the CTAs are gone because the ask
  lives later in the page. Everything else, the scroll assembly, the drag
  physics, the five windows, the fox film, is the homepage hero unchanged,
  because that hero is the proven arrival and beat 1 of the dictated brief.
  Styles are the global ah- block in globals.css, loaded site-wide.
*/
...
export default function ProspectHero({
  kicker,
  headline,
  sub,
  instruction = "launch a campaign to 200 marketers who just changed roles",
}: {
  kicker: string;
  headline: string;
  sub: string;
  ...
  useEffect(() => {
    ...
    /* ===== OUTREACH inbox ===== */
    const cyc = [
      { ini: "RC", cls: "ah-a1", name: "Ruth Carmody", sub: "Director · Carmody & Lyle Insurance Brokers",
        out: "Hi Ruth - noticed Carmody & Lyle picked up two new commercial accounts this month. Kite quotes commercial the same day, no re-keying. Worth a look?",
        reply: "Send me the broker portal login, I'll take a look this week." },
      { ini: "MD", cls: "ah-a3", name: "Michael Doran", sub: "Broker Principal · Doran Cover",
        out: "Hi Michael - a lot of brokers are chasing quote turnaround right now. Kite's same-day on commercial and motor fleet. Open to a quick call?",
        reply: "Yes - Thursday afternoon works." },
      { ini: "AB", cls: "ah-a2", name: "Aisling Byrne", sub: "Commercial Lines Manager · Byrne Foran",
        out: "Hi Aisling - saw Byrne Foran is growing the commercial book. We renewed three of your clients last year without a single query. Worth ten minutes?",
        reply: "Sounds good, happy to chat." },
      { ini: "ED", cls: "ah-a4", name: "Emma Deasy", sub: "Managing Broker · Deasy & Hart",
        out: "Hi Emma - Deasy & Hart quoted us twice last year and went elsewhere both times. One thing has changed at Kite that's worth two minutes.",
        reply: "Go on - what's changed?" },
    ];
    ...
    const pool: [string, string, string, boolean?][] = [
      ["Niamh Hartnett", "ah-a7", "You: your motor fleet book is growing…"],
      ["Conall Breen", "ah-a8", "Conall: sure, happy to chat", true],
      ["Sile Morrissey", "ah-a2", "You: one idea on renewals worth a look…"],
      ["Peter Lavin", "ah-a3", "You: noticed the new Cork office…"],
      ["Grainne Fox", "ah-a5", "Grainne: what did you have in mind?", true],
      ["Tomas Keating", "ah-a6", "You: quick thought on commercial lines…"],
    ...
    const EHTML =
      ...
      '<p class="ah-reveal" style="animation-delay:.45s">The research before Tuesday&rsquo;s call with <b>Kite Insurance</b>. Fourteen marketers across three lines of business, and the strongest broker word-of-mouth in the segment.</p>' +
      '<p class="ah-reveal" style="animation-delay:.8s">Brokers name <b>quote turnaround</b> as their top switching trigger, and Kite already wins it. Nobody is telling them.</p>' +
      "<ul>" +
      '<li class="ah-reveal" style="animation-delay:1.15s">Renewal comms are the <b>quiet strength</b> - three renewals, zero queries, worth saying out loud.</li>' +
      '<li class="ah-reveal" style="animation-delay:1.45s">Lapsed brokers are the <b>open goal</b> - they already know the product.</li>' +
      "</ul>" +
      '<div class="ah-att ah-reveal" style="animation-delay:1.75s"><span class="ah-ic">▤</span>kite-brief.pdf · 2 pages</div>';
    const runResearch = () => {
      if (!ebody) return;
      ...
      <div className="ah-hero">
        <div className="ah-sticky">
          <div className="ah-head">
            <span className="ah-kicker">{kicker}</span>
            <h1>{headline}</h1>
            ...
            <div className="ah-win ah-terminal ah-sat" data-dx="-476" data-dy="238" data-sc="0.84">
              <div className="ah-term-win">
                ...
                <div className="ah-term-body">
                  ...
                  <div className="ah-resp ah-termresp"><span className="ah-dot"></span><span><b>heard</b> - the redesign of that workflow is in section 06</span></div>
                </div>
              </div>
            </div>
                ...
                <div className="ah-panel"><div className="ah-ibx">
                  <div className="ah-list">
                    ...
                    <div className="ah-threads">
                      <div className="ah-th ah-sel"><span className="ah-av ah-a1">RC</span><div className="ah-mid"><div className="ah-nm">Ruth Carmody</div><div className="ah-pv"><b>You:</b> two new commercial accounts…</div></div><span className="ah-t">now</span></div>
                      <div className="ah-th"><span className="ah-av ah-a3">MD</span><div className="ah-mid"><div className="ah-nm">Michael Doran <span className="ah-u"></span></div><div className="ah-pv"><b>Michael:</b> Thursday afternoon works</div></div><span className="ah-t">2m</span></div>
                      <div className="ah-th"><span className="ah-av ah-a2">AB</span><div className="ah-mid"><div className="ah-nm">Aisling Byrne</div><div className="ah-pv"><b>You:</b> three renewals, not one query…</div></div><span className="ah-t">6m</span></div>
                      <div className="ah-th"><span className="ah-av ah-a4">ED</span><div className="ah-mid"><div className="ah-nm">Emma Deasy</div><div className="ah-pv"><b>Emma:</b> go on - what&apos;s changed?</div></div><span className="ah-t">11m</span></div>
                    </div>
                  </div>
              ...
              <div className="ah-frame-win">
                ...
                <div className="ah-panel"><div className="ah-eml">
                  <div className="ah-ehd">
                    <div className="ah-subj">Research before our first call with Kite</div>
            ...
            <div className="ah-win ah-film">
              <div className="ah-frame-win">
                ...
                <div className="ah-panel">
                  <video src="/video/hyperspeed.mp4" autoPlay muted loop playsInline preload="auto" />
              ...
              <div className="ah-frame-win">
                ...
                <div className="ah-panel"><div className="ah-bpw">
                  <div className="ah-bpbar">
                    <span className="ah-crumb">Workflows › <b>Broker renewal outbound</b></span>
                  ...
                  <div className="ah-bpmain">
                    <div className="ah-bpcanvas">
                      ...
                      <div className="ah-bpnode ah-trig" data-step="0" style={{ left: "10%", top: "50%" }}><div className="ah-nh"><span className="ah-ic">◆</span><span className="ah-bpnm">Quote lapsed</span></div><div className="ah-st">trigger</div></div>
                      <div className="ah-bpnode" data-step="1" style={{ left: "36%", top: "50%" }}><div className="ah-nh"><span className="ah-ic">◱</span><span className="ah-bpnm">Enrich broker</span></div><div className="ah-st">step</div></div>
                      <div className="ah-bpnode" data-step="2" style={{ left: "64%", top: "28%" }}><div className="ah-nh"><span className="ah-ic">▤</span><span className="ah-bpnm">Renewal brief</span></div><div className="ah-st">agent</div></div>
