// → src/app/proposals/yellowharbour/ProposalGate.tsx   (replace yellowharbour and Yellow Harbour)
"use client";
...
export default function ProposalGate({
  ...
  if (authed) {
    return (
      <iframe
        src="/proposals/yellowharbour/index.html"
        title="Yellow Harbour proposal"
    ...
    >
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <div style={{ fontSize: 11, letterSpacing: 2, textTransform: "uppercase", color: "#3A7CA5", marginBottom: 18 }}>
          Private proposal · Yellow Harbour
        </div>
