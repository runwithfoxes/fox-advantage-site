// → src/app/proposals/santegic/ProposalGate.tsx   (replace santegic and Santegic)
"use client";
...
export default function ProposalGate({
  ...
  if (authed) {
    return (
      <iframe
        src="/proposals/santegic/index.html"
        title="Santegic proposal"
