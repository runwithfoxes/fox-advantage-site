// → src/app/proposals/ari/ProposalGate.tsx   (replace ari and ARI Athletics)
"use client";
...
export default function ProposalGate({
  ...
  if (authed) {
    return (
      <iframe
        src="/proposals/ari/index.html"
        title="ARI Athletics proposal"
    ...
    >
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <div style={{ fontSize: 11, letterSpacing: 2, textTransform: "uppercase", color: "#3A7CA5", marginBottom: 18 }}>
          Private proposal · ARI Athletics
        </div>
