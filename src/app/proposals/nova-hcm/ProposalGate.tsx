// → src/app/proposals/nova-hcm/ProposalGate.tsx   (replace nova-hcm and Nova HCM)
"use client";
...
export default function ProposalGate({
  ...
  if (authed) {
    return (
      <iframe
        src="/proposals/nova-hcm/index.html"
        title="Nova HCM proposal"
