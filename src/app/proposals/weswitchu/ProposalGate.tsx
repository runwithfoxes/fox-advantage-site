// → src/app/proposals/weswitchu/ProposalGate.tsx   (replace weswitchu and WeSwitchU)
"use client";
...
export default function ProposalGate({
  ...
  if (authed) {
    return (
      <iframe
        src="/proposals/weswitchu/index.html"
        title="WeSwitchU proposal"
