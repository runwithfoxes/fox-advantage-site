// → src/app/proposals/hearwell/ProposalGate.tsx   (replace hearwell and HearWell Health)
"use client";
...
export default function ProposalGate({
  ...
  if (authed) {
    return (
      <iframe
        src="/proposals/hearwell/index.html"
        title="HearWell Health proposal"
    ...
    >
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <div style={{ fontSize: 11, letterSpacing: 2, textTransform: "uppercase", color: "#3A7CA5", marginBottom: 18 }}>
          Private proposal · HearWell Health
        </div>
