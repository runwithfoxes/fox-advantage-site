...
export const deliverables: Deliverable[] = [
  ...
  { name: "Blog writer", detail: "AI writer for blog posts and longer-form content, nine types", status: "ready", statusLabel: "Paul is testing it - have a go too", date: "2026-06-28", note: "Built on the email writer's foundations: same voice, same plan-first-then-prove-it method, same verification ledger. Nine long-form types (point of view, explainer, product deep-dive, case study, data insight, trend, practical guide, news reaction, recap). Paul is putting it through its paces, so treat this as an early version, but it is ready for you to download and test alongside him. Load it the same way as the email writer.", download: { file: "sabre-blog-writer-v1.1.sabre.zip", label: "Download the skill (v1.1)" }, isNew: true },
  { name: "Web copy writer", detail: "AI writer for website and landing page copy", status: "todo", note: "Next in the set." },
  { name: "Organic social writer", detail: "AI writer for organic social posts, LinkedIn-first", status: "ready", statusLabel: "Paul is testing it - have a go too", date: "2026-06-28", note: "Built on the same foundations as the email and blog writers (voice, plan-first method, verification ledger), plus Paul's own LinkedIn strategic framework and recent LinkedIn research baked in. Every post is written to one of five goals, the hook is written first and hardest, and it knows how the 2026 LinkedIn algorithm actually behaves. Paul is testing it, but it is ready for you to download and try alongside him.", download: { file: "sabre-organic-social-writer-v1.0.sabre.zip", label: "Download the skill (v1.0)" }, isNew: true },
  { name: "Paid social writer", detail: "AI writer for paid social copy (LinkedIn, Meta)", status: "todo", statusLabel: "Deferred for now", note: "An ads writer is the hardest of the set, so we are doing the writing-led tools first (blog, organic social, web copy) and coming back to paid." },
...
export const work: WorkSection[] = [
  ...
  { title: "Blog writer (v1.1)", kind: "files", zone: "work", status: "ready", badge: "Paul is testing - try it too",
    desc: "The Sabre blog writer, covering nine long-form types: point of view, explainer, product deep-dive, case study, data insight, trend, practical guide, news reaction, and event recap. It is built on the email writer's foundations, so it works the same way: it declares a plan before it writes, writes in the real Sabre voice, then proves its facts with the same verification ledger (every claim gets a row, a status, and a pasted source) before it shows its working. Paul is testing this himself right now, so treat it as an early version, but it is available for you to download and try alongside him. Download the skill below and load it into Claude the same way as the email writer (Customize, then Skills, then Create skill). It works best in a project where Sabre's positioning is loaded, so it can cite real specifics rather than flag them as gaps. The version and a full changelog are inside the zip.",
    files: [
      { name: "Sabre Blog Writer v1.1", file: "sabre-blog-writer-v1.1.sabre.zip", note: "Claude skill, zip, v1.1", date: "2026-06-28" },
    ] },

  { title: "Organic social writer (v1.0)", kind: "files", zone: "work", status: "ready", badge: "Paul is testing - try it too",
    desc: "The Sabre organic social writer, LinkedIn-first. It works the same way as the email and blog writers (plan first, write, prove the facts with the verification ledger, show the checks), with three things layered in for social. One: every post is written to a single goal (salience, get talked about, value add, authority build, or a specific call to action), because a post chasing two goals serves neither. Two: the hook (the first two lines, the bit people see before clicking more) is written first and hardest, with several options generated each time, because most readers never expand the post. Three: it knows how LinkedIn actually behaves in 2026 (saves and comments drive reach more than likes, the first ninety minutes matter, a named person reaches far more people than the company page), and it writes to that. Paul is testing it himself, so treat it as an early version, but it is ready for you to download and try alongside him. Load it the same way as the others, and it works best in a project where Sabre's positioning is loaded.",
    files: [
      { name: "Sabre Organic Social Writer v1.0", file: "sabre-organic-social-writer-v1.0.sabre.zip", note: "Claude skill, zip, v1.0", date: "2026-06-28" },
    ] },
  ...
  { title: "Brief coach", kind: "files", zone: "work", wideDesc: true, isNew: true, badge: "First version built, in testing",
    desc: "A coach, inside Sabre's own Claude, that takes a rough brief and makes it good. It plugs into Darren's flow above, at stations one and two, where briefs are born. It leads with a diagnosis: it holds the brief to what good looks like, shows where it falls short, then helps you close the gaps, whether you arrive with a draft to improve or a blank page to work through. It pins the vague bits, holds every brief to a real commercial outcome, and presses for the things a strong brief needs: one clear goal, real numbers, and an insight that names a moment rather than a job title. It routes by the kind of brief in front of it, so a flagship campaign gets the full treatment while a production brief simply gets pinned until anyone could build it. The standard it measures against is Sabre's own positioning plus our marketing-effectiveness thinking, baked in so it lifts the quality without asking the writer to already know what good looks like. Paul is still testing and refining this first version, so treat it as a work in progress, but you are very welcome to load it into your Claude and try it yourself. Download the skill below and add it the same way as the email writer (Customize, then Skills, then Create skill). It works best in a project where Sabre's positioning is loaded, so it can cite real specifics rather than flag them as gaps.",
    files: [
      { name: "Sabre Brief Coach v1", file: "sabre-brief-coach.sabre.zip", note: "Claude skill, zip, v1 (Paul testing)", date: "2026-06-25" },
    ] },

  { title: "What would April say?", kind: "files", zone: "work", wideDesc: true, isNew: true, badge: "Experiment Paul added",
    desc: "Something Paul added as an experiment, not part of the agreed plan, so treat it as a work in progress. It is a quick positioning advisor that lives inside Sabre's own Claude. Ask it what April Dunford would say about a tagline, a one-liner, a claim, a category question or a competitive move, and it gives you her reasoned read, in her voice. It is the lighter, answer-giving cousin of the brief coach: where the coach works a whole brief and only asks questions, this one gives you a view on a single thing. It runs her actual method underneath, the positioning canvas and her quality tests, and it is decisive about the craft while leaving the business call to you. The Mosaic agency positioning is baked in, so it can cite real specifics like the payments and insight proof points and the Amadeus contrast rather than talk in general terms. It does not invent a Sabre fact: where something is not loaded, the airline side for instance, it tells you and asks. Download the skill below and add it the same way as the others (Customize, then Skills, then Create skill). It works best in a project where your full positioning is loaded, so it has the latest detail to draw on.",
    files: [
      { name: "What Would April Say? v1", file: "sabre-what-would-april-say.sabre.zip", note: "Claude skill, zip, v1 (experiment, Paul testing)", date: "2026-06-25" },
    ] },
