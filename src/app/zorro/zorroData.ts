...
Every name and every swipe is made up. Nobody in these files exists.`,
    ...
    files: [
      ...
      { name: "enrique-role.md", what: "Enrique's job in the four-question shape. The model for your own agent's role.", href: "/zorro/enrique-role.md" },
